...

{
    ...
    is $helper->escape_url('/test/index.html?value=test&escape=-^@[:],./'),
...

{
    ...
    is $helper->url('/path', { params => [1,2,3], action => 'ACTION', '' => 'empty name', 'empty value' => undef }, 'HASH' ),
        '/path?action=ACTION&empty%20value&params=1%2C2%2C3#HASH';
}
